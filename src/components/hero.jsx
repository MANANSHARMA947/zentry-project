...
const Hero = () => {
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidder">
      ...
      <div
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            <h1 className="special-font hero-heading text-blue-100 tracking-[8px]">
              redefi<b>n</b>e
            </h1>
      ...
      <h1 className="special-font hero-heading absolute bottom-5 right-5  text-black tracking-[15px]">
        G<b>a</b>ming
      </h1>
    </div>
  );
